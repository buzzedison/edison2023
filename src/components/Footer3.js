              ...
              <Grid item={true} xs={12} md={4}>
                <List disablePadding={true}>
                  ...
                  <ListItem
                    button={true}
                    component="a"
                    href="https://medium.com/@buzzedison"
                  ...
                  <ListItem
                    button={true}
                    component="a"
                    href="https://vocal.media/authors/edison-ade"
                    className={classes.listItem}
                  >
                    <ListItemText>Vocal Media</ListItemText>
                  </ListItem>
                </List>
              </Grid>
              <Grid item={true} xs={12} md={4}>
              ...
              <Grid item={true} xs={12} md={4}>
                <List disablePadding={true}>
                  ...
                  <ListItem
                    button={true}
                    component="a"
                    href="https://facebook.com/buzzedison/"
                    target="_blank"
                    rel="noreferrer"
                    className={classes.listItem}
                  >
                  ...
                  <ListItem
                    button={true}
                    component="a"
                    href="https://instagram.com/gbengaedison"
                    target="_blank"
                    rel="noreferrer"
                    className={classes.listItem}
                  >
